      ...
      <div className="mt-20 mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="bg-white shadow sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 text-center">
            ...
            {/* <p className="mt-1 max-w-2xl text-sm text-gray-500 mx-auto">Last updated on 19-05-2024 15:00:05</p> */}
          </div>
            ...
            <dl>
              <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-6">
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 text-center">
                  <p>
                    ...
                    KRISHNA SINGH, ("Website Owner" or "we" or "us" or "our") and
                    you ("you" or "your") and relate to your use of our website,
              ...
              <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-6">
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 text-center">
                  ...
                  <ul className="list-disc pl-5 space-y-1 mt-4 mx-auto text-left inline-block">
                    <li>
