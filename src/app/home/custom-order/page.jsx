            ...
            <main className="container mx-auto px-4 py-12 mt-28 pb-32">
                ...
                <section className="mt-16">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        ...
                        {[
                            { src: "https://res.cloudinary.com/dafv5daza/image/upload/v1716724876/sukuna_backkkk_rswfet.png", title: "Anime Design 1" },
                            { src: "https://res.cloudinary.com/dafv5daza/image/upload/v1716724891/white_back_tut1y7.png", title: "Anime Design 2" },
                            { src: "https://res.cloudinary.com/dafv5daza/image/upload/v1716724938/i_back_fwxduz.png", title: "Anime Design 3" },
                            { src: "https://res.cloudinary.com/dafv5daza/image/upload/v1716724291/back_mockup_hccwlm.png", title: "Anime Design 4" }
                        ].map((item, index) => (
                            <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden transform transition duration-300 hover:scale-105">
                                <img src={item.src} alt="Featured Design" className="w-full h-48 object-cover" />
                                <div className="p-4">
