...
export const logout = () => async (dispatch) => {
  try {
    ...
    await axios.get("https://kriptees-backend-ays7.onrender.com/api/v1/logout");
...
export const getAllUsers = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("https://kriptees-backend-ays7.onrender.com/api/v1/admin/users", config);
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://kriptees-backend-ays7.onrender.com/api/v1/admin/user/${id}`,
      config
    );
